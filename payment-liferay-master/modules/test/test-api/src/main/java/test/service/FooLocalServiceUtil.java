 ...
 * <code>test.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>test.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static test.model.Foo addFoo(test.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static test.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static test.model.Foo deleteFoo(test.model.Foo foo) {
	 ...
	 */
	public static test.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static test.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static test.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static test.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static test.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<test.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	public static java.util.List<test.model.Foo> getFoosByUuidAndCompanyId(
	...
	public static java.util.List<test.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<test.model.Foo>
			orderByComparator) {
	 ...
	 */
	public static test.model.Foo updateFoo(test.model.Foo foo) {
