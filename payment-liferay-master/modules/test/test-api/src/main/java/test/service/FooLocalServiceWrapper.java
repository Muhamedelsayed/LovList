...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public test.model.Foo fetchFooByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	@Override
	public test.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<test.model.Foo> getFoosByUuidAndCompanyId(
