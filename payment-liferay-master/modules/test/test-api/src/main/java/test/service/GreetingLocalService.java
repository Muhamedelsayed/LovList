...
/**
 * Provides the local service interface for Greeting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GreetingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GreetingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>test.service.impl.GreetingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the greeting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GreetingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Greeting createGreeting(long greetingId);
	...
	public Greeting deleteGreeting(Greeting greeting);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Greeting deleteGreeting(long greetingId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Greeting fetchGreeting(long greetingId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Greeting getGreeting(long greetingId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Greeting> getGreetings(int start, int end);
