...
import test.exception.NoSuchFooException;

import test.model.Foo;
import test.model.impl.FooImpl;
import test.model.impl.FooModelImpl;

import test.service.persistence.FooPersistence;
import test.service.persistence.impl.constants.FOOPersistenceConstants;
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", Foo.class.getName()));
