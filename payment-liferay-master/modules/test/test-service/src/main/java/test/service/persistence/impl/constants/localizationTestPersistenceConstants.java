...
package test.service.persistence.impl.constants;
 ...
 * @generated
 */
public class localizationTestPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "test.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			localizationTestPersistenceConstants.class);
