...
/**
 * Provides the local service interface for TESTT. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TESTTLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TESTTLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>anb.ejada.DataTest.service.impl.TESTTLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the testt local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TESTTLocalServiceUtil} if injection and service tracking are not available.
	 */
